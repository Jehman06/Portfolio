                    ...
                    <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            ...
                            <a className="text-indigo-400 leading-relaxed" href="mailto: jeremy.lehmann06@icloud.com">
                                jeremy.lehmann06<br />@icloud.com
                            </a>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            ...
                            <a className="text-indigo-400 leading-relaxed" href="https://www.linkedin.com/in/jeremy-lehmann/" target="_blank" rel="noreferrer noopener">
                                linkedin.com/in/jeremy-lehmann/
                            </a>
                        </div>
                    </div>
                </div>
